...
public interface ClickHouseParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ClickHouseParser#existsStmt}.
	 * @param ctx the parse tree
	 */
	void enterExistsStmt(ClickHouseParser.ExistsStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link ClickHouseParser#existsStmt}.
	 * @param ctx the parse tree
	 */
	void exitExistsStmt(ClickHouseParser.ExistsStmtContext ctx);
	/**
